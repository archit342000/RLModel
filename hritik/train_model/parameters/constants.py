...
def collect_global_constants(parameters, job_dir):
    ...
    constants_dict["test_set"] = parameters["test"] + "test.csv"
    constants_dict["training_set"] = parameters["train"] + "train.csv"
    constants_dict["validation_set"] = parameters["valid"] + "valid.csv"
    ...
    if constants_dict["job_type"] != "preprocess":
        ...
        csv_file = parameters["train"] + "preprocessing_params.csv"
...
constants = collect_global_constants(parameters=defaults.params_dict,
                                     job_dir=defaults.params_dict["job_dir"])
